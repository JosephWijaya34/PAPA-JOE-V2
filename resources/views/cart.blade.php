    ...
    @auth
        ...
        <div class="container mx-auto px-4 py-12 ">
            ...
            <form action="{{ route('cart-redirect') }}" method="POST">
                ...
                <input type="hidden" name="transaction_id" value="{{ $transactionCart->id }}">
                {{-- {{ dd($transactionCart->id ) }} --}}
                                ...
                                <div class="mt-10">
                                    <div class="grid grid-cols-2 md:grid-cols-6">
                                        <div class="col-span-2">
                                            <img class="rounded-xl" src="{{ asset('storage/' . $product->image) }}" alt="Foto Makanan">
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <input name="quantity[]"
                                                ...
                                                type="number" min="1" value="{{ $product->pivot->quantity }}" readonly>
                                        </div>
