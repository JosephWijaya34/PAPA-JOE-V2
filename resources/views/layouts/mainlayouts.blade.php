        ...
        <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a href="https://flowbite.com/" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PAPA JOE'S</span>
                </a>
                <div class="flex items-center md:order-2">
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full" src="image/profile.jpg"
                            alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        id="user-dropdown">
                        <div class="px-4 py-3">
                            <span class="block text-sm text-gray-900 dark:text-white">Risky</span>
                            <span
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-white bg-navColour rounded md:bg-transparent md:text-navColour lg:hover:text-navColour md:p-0 dark:text-white"
                                aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-700 rounded xs:hover:text-white sm:hover:text-white hover:bg-navColour md:hover:bg-transparent md:hover:text-navColour md:p-0 dark:text-white md:dark:hover:text-navColour dark:hover:bg-gray-700 dark:hover:text-navColour md:dark:hover:bg-transparent dark:border-gray-700">About</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-navColour xs:hover:text-white sm:hover:text-white  md:hover:bg-transparent md:hover:text-navColour md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Menu</a>
                        </li>
                        <li>
                            <a href="#"
