...
@section('content')
    ...
    <div class="mx-auto p-2 lg:mt-10 lg:max-w-[1240px]">
        <div class="grid grid-cols-2">
            ...
            <div class="p-5">
                <h1 class="text-2xl font-semibold">Hokky Darmo</h1>
                <h3 class="text-lg">lokasi</h3>
                <p class="text-lg">no telp</p>
            </div>
        </div>
    </div>
    {{-- mitra info end --}}
    ...
    <div class="mx-auto p-2 lg:mt-10 lg:max-w-[1240px]">
        <div class="flex flex-col justify-center items-center">
            <p class="text-3xl font-bold text-papa-merah-100">Menu yang tersedia di hokky darmo</p>
        </div>
